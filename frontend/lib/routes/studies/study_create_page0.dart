...
class StudyCreatePage0 extends StatefulWidget {
  final Function(String, String) getNext;

  const StudyCreatePage0({
    Key? key,
    required this.getNext,
  }) : super(key: key);

  @override
  State<StudyCreatePage0> createState() => _StudyCreatePage0State();
}

class _StudyCreatePage0State extends State<StudyCreatePage0> {
