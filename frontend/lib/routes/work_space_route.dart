...
import 'package:group_study_app/widgets/percent_graphs/bar_percent_graph.dart';
          ...
          child: Padding(
            ...
            child: Column(
              children: [
                ...
                BarPercentGraph(percentInfos: [ PercentInfo(percent: 0.4, color: ColorStyles.red)
