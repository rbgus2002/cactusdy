...
const double _maxDayPickerHeight = _dayPickerRowHeight * (_maxDayPickerRowCount + 1.75); //< [EDIT]
...
const double _subHeaderHeight = 36.0; //< [EDIT]
...
class _DatePickerModeToggleButtonState extends State<_DatePickerModeToggleButton> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    final Color controlColor = colorScheme.onSurface; //< [EDIT]
...
class _MonthPickerState extends State<_MonthPicker> {
  ...
  @override
  Widget build(BuildContext context) {
    //final Color controlColor = Theme.of(context).colorScheme.onSurface; //< [EDIT]
          ...
          Container(
            ...
            child: Row(
              children: <Widget>[
                const Spacer(),
                IconButton(
                  icon: const Icon(CustomIcons.chevron_left), //< [EDIT]
                  iconSize: 32,
                  splashRadius: 16,
                ...
                IconButton(
                  icon: const Icon(CustomIcons.chevron_right), //< [EDIT]
                  iconSize: 32,
                  splashRadius: 16,
                  color: context.extraColors.grey500,
...
class _DayPickerState extends State<_DayPicker> {
  ...
  Widget build(BuildContext context) {
    ...
    final TextStyle weekdayStyle = TextStyles.body2.copyWith(color: context.extraColors.grey500);
