...
class OldTaskGroupWidget extends StatefulWidget {
  ...
  @override
  State<OldTaskGroupWidget> createState() => OldTaskGroupWidgetState();
}

class OldTaskGroupWidgetState extends State<OldTaskGroupWidget> {
