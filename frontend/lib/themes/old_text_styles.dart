...
class OldTextStyles {
  ...
  static const hintTextStyle = TextStyle(fontSize: 12, color: OldColorStyles.lightGrey);
  ...
  static const taskTextStyle = TextStyle(fontSize: 14, fontWeight: medium, height: 1, color: OldColorStyles.taskTextColor);

  static const roundTextStyle = TextStyle(fontSize: 14, fontWeight: semiBold, height: 1, color: OldColorStyles.taskTextColor);
  static const roundHintTextStyle = TextStyle(fontSize: 14, fontWeight: FontWeight.normal, height: 1, color: OldColorStyles.taskHintTextColor);


  static const wideTextStyle = TextStyle(fontSize: 16, fontWeight: semiBold, letterSpacing: 2);

  static const errorTextStyle = TextStyle(fontSize: 12, color: OldColorStyles.errorColor);
}