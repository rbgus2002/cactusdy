...
public class StudyController {
    ...
    public ResVo editStudy(@PathVariable Long studyId,
        ...
        return DataResVo.of("studyId", editedStudyId);
    }

    @Operation(summary = "스터디 초대코드 가져오기")
    @GetMapping("/{studyId}/inviteCode")
    public ResVo getInviteCode(@PathVariable Long studyId) {
        final String inviteCode = studyService.getInviteCode(studyId);
        return DataResVo.of("inviteCode", inviteCode);
    }
}