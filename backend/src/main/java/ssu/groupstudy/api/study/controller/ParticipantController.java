...
public class ParticipantController {
    ...
    @PostMapping
    public ResVo inviteUser(@AuthenticationPrincipal CustomUserDetails userDetails, @RequestParam String inviteCode){
    ...
    @DeleteMapping
    public ResVo leaveUser(@AuthenticationPrincipal CustomUserDetails userDetails, @RequestParam Long studyId){
    ...
    @DeleteMapping("/kick")
    public ResVo kickParticipant(@AuthenticationPrincipal CustomUserDetails userDetails, @RequestParam Long userId, @RequestParam Long studyId){
