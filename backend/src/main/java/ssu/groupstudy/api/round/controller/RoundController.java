...
public class RoundController {
    ...
    @PostMapping
    public ResponseDto createRound(@RequestParam Long studyId, @Valid @RequestBody AppointmentReqVo dto){
    ...
    @PatchMapping
    public ResponseDto updateAppointment(@RequestParam Long roundId, @Valid @RequestBody AppointmentReqVo dto){
    ...
    public ResponseDto updateDetail(@RequestParam Long roundId, @RequestBody DetailReqVo dto){
